...
<div class="confirm-area user-area">
	<article>
		...
		<div class="confirm_box">
			<p class="mB20">일반회원</p>
			<div class="btn-cont">
				<a href="/join/memberRegist.do?loginType=normal" class="btn spot member-type">
					<span>회원가입</span>
				</a>
			</div>
		</div>
		...
		<div class="confirm_box">
			...
			<div class="btn-cont">
				<a href="#" class="btn-kakao" data-type="join">
					<img alt="카카오 로그인 버튼" src="http://k.kakaocdn.net/14/dn/btroDszwNrM/I6efHub1SN5KCJqLm1Ovx1/o.jpg" width="150" />
				</a>
			</div>
		</div>
	</article>
...
// 카카오 키 정보 입력
Kakao.init('30933b7263cd751325cb49c4cd0c49c5');	// 본인의 JavaScript 키
