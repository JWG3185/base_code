...
<p class="mB20">회원가입을 위해 아래의 정보를 입력해주십시오. <br class="m-block" /><strong class="star">*</strong>표시는 필수 입력사항 입니다.</p>

<h3 class="icon2 hidden">기본정보</h3>
<form action="/join/insertMember.do" id="frm" name="frm" method="post" onsubmit="return regist();">
	...
	<table class="join_chart">
		...
		<tbody>
			...
			<tr>
				...
				<td><input type="text" id="userNm" name="userNm" required="required"/></td>
			</tr>
			<tr>
