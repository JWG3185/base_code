...
<div class="bg-area change_box">
	<form action="/member/findPasswordComplete.do" id="passwordCnfirm" method="post" onsubmit="return checkForm(this)">
		<fieldset>
			<legend>비밀번호 변경 폼</legend>
			<input type="hidden" name="esntlId" value='<c:out value="${result.esntlId}" />' />
