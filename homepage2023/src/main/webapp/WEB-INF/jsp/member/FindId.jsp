...
<div class="bg-area change_box">
	<form action="/member/findIdComplete.do" id="frm" name="frm" method="post" onsubmit="return checkForm(this)">
		<fieldset>
			<legend>아이디 찾기 폼</legend>
			<div class="change_inp">
				<div>
					<label for="userNm">회원명</label>
					<input type="text" id="userNm" name="userNm" class="inp" />
				</div>
				<div>
					<label for="emailAdres">이메일</label>
					<input type="text" id="emailAdres" name="emailAdres" class="inp" />
				</div>
				<div>
				...
				<div>
					...
					<input type="text" id="passwordCnsr" name="passwordCnsr" class="inp" />
				</div>
			</div>
			<div class="btn-cont">
