...
<%-- <c:url var="rinkUrl" value="/board/selectList.do">
	<c:param name="boardType" value="IMAGE" />
	<c:param name="boardType" value="NORMAL" />
	<c:param name="boardType" value="NOTICE" />
</c:url> --%>

<a href="/board/selectList.do?boardType=NORMAL" >일반게시판</a> | 
<a href="/board/selectList.do?boardType=IMAGE">썸네일게시판</a> | 
<a href="/board/selectList.do?boardType=NOTICE">공지게시판</a>
			...
			<form name="frm" method="post" action="/board/selectList.do">
				<fieldset>
					...
					<select name="searchCondition" id="ftext">
						<option value="0" <c:if test="${searchVO.searchCondition eq '0'}" ></c:if>>제목</option>
						<option value="1" <c:if test="${searchVO.searchCondition eq '1'}" ></c:if>>내용</option>
						<option value="2" <c:if test="${searchVO.searchCondition eq '2'}" ></c:if>>작성자</option>
					</select>
