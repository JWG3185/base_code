...
public class MailServiceImpl extends EgovAbstractServiceImpl implements MailService {
	...
	public void sendMail(Session session, String title, String content, String receiver) throws Exception{
		...
		System.out.println(propertyService.getString("mail.gmailUser"));
		System.out.println(propertyService.getString("mail.gmailUserName"));
		System.out.println(propertyService.getString("mail.gmailPassword"));
