...
public interface ReservationApplyMapper {
	...
	//예약자 정보 목록 가져오기
	List<EgovMap> selectReservationApplyList(ReservationApplyVO vo);

	//예약자 정보 목록 수
	int selectReservationApplyListCnt(ReservationApplyVO vo);
	...
	//예약정보 승인
	void updateReservationConfirm(ReservationVO vo) throws Exception;
