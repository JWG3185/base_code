...
public class ReservationAdminApplyController {
	...
	public ModelAndView excel(@ModelAttribute("searchVO") ReservationApplyVO searchVO, HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception{
		...
		if(resultList != null) {
			...
			for (int i = 0; i < resultList.size(); i++) {
				...
				tmpMap.put("신청일", tmpVO.get("frstRegistPnttmYmd").toString());	//FRST_REGIST_PNTTM_YMD
	...
	public @ResponseBody JsonResponse excelUpload(@ModelAttribute ReservationApplyVO searchVO, HttpServletRequest request, HttpServletResponse response, ModelMap model
